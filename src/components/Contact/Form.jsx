    ...
    const onSubmit = (data) => {
        ...
        return (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='mx-auto' noValidate>
                <div className='grid grid-cols-2 gap-4'>
                    <div className='mb-4'>
                        ...
                        <input type='text' id='name' name='name' placeholder='Enter your name'
                            ...
                            })} className=' text-black mt-1 block w-full shadow-sm text-lg border-gray-300 rounded-md'/>
                ...
                <div className='mb-4'>
                    <button type='submit' className='inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white'>Submit</button>
                </div>
            </form>
        )
    }
