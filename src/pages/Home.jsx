            ...
            <section id='section2' className='grid grid-cols-12 md:min-h-screen pt-8 lg:-my-16'>
                <div className='col-span-12 md:col-span-10 md:col-start-2 xl:col-span-8 xl:col-start-3'>
                    ...
                    <div className="flex justify-center items-center">
                        <a className='text-2xl md:text-4xl mx-auto text-center bg-green-500 px-4 my-4 border-2 border-gray-300 rounded-lg text-black animate-pulse' href='https://github.com/Big-pun/my-portfolio' target='_blank'>
